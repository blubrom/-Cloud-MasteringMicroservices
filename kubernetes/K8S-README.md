...
```
$ docker image tag gateway blubrom/gateway
$ docker push blubrom/gateway
$ docker image tag invoice blubrom/invoice
$ docker push blubrom/invoice
$ docker image tag notification blubrom/notification
$ docker push blubrom/notification
$ docker image tag productorder blubrom/productorder
$ docker push blubrom/productorder
```
